...
001换货售后单生成
    ...
    Sleep    2
    Selenium2Library.Input Text    //form/div[1]/div/div/input    ${newOrderId}
    Sleep    2
    Send    {ENTER}
    #售后类型-换货
    Sleep    2
    ...
    #售后原因
    #Sleep    2
    #Selenium2Library.Click Button    //form/div[2]/div[3]/div/div/div[1]/input
    #真实原因
    Sleep    2
...
005导出
    ...
    #Wait Until Keyword Succeeds    20s    10s    Selenium2Library.Click Button    //div[3]/div/button
    Sleep    2
    ${fileName1}    Selenium2Library.Get Text    //div/div[2]/div[1]/div[2]/p[1]
    log    ${fileName1}
